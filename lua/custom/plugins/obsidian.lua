  ...
  opts = {
    ...
    workspaces = {
      ...
      },
      {
        ...
        path = "/Users/gambhirsharma/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/Engineering-Sciences",
      },
    },
    -- see below for full list of options 👇
    templates = {
      folder = "/Users/gambhirsharma/Library/CloudStorage/OneDrive-Universita'degliStudidiRomaTorVergata/OBSIDIAN/assets/Template",
      date_format = "%Y-%m-%d-%a",
      time_format = "%H:%M",
    },
