...
vim.keymap.set({ "n", "v" }, "<leader>nd", function()
  M.toggle_checkbox("x")
end, { desc = "Todo done", noremap = true })
vim.keymap.set({ "n", "v" }, "<leader>nc", function()
  M.toggle_checkbox("o")
end, { desc = "Todo canceled", noremap = true })
vim.keymap.set({ "n", "v" }, "<leader>nu", function()
  M.toggle_checkbox(" ")
end, { desc = "Todo undone", noremap = true })
vim.keymap.set({ "n", "v" }, "<leader>ni", function()
  M.toggle_checkbox("~")
end, { desc = "Todo in progress", noremap = true })
vim.keymap.set({ "n", "v" }, "<leader>nr", function()
  M.toggle_checkbox()
end, { desc = "Remove todo", noremap = true })
